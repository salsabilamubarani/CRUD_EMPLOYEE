...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="{{ asset('sb-admin-dua/kucing/vendor/morrisjs/morris.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('sb-admin-dua/kucing/vendor/raphael/raphael.min.js') }}"></script>
    <script src="{{ asset('sb-admin-dua/kucing/vendor/morrisjs/morris.min.js') }}"></script>
    <script src="{{ asset('sb-admin-dua/kucing/data/morris-data.js')}}"></script>
